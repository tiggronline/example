...
namespace Battleship.Api
{
    ...
    /// <summary>
    /// Swagger/Swashbuckle operation filter used to document the implicit API version parameter.
    /// </summary>
    /// <remarks>
    /// This <see cref="IOperationFilter"/> is only required due to bugs in the <see cref="SwaggerGenerator"/> 
    ///  and can be removed once fixed and published.
    /// Obtained from the Swagger sample in https://github.com/dotnet/aspnet-api-versioning.git
    /// </remarks>
